...
test("getUrl string is correct", () => {
  ...
  const hmacs = {
    "S300x225*W0seO": "2fdbb7f8f2c8ecf49ac437a40b25950ff8c930e9"
  };
  const client = new BobRossClient({ serverUrl, hmacs });
  const hash = "256cd9a0e3824a9b81e9f41e616019e8";
  const options = { resize: "300x225*" };
  const url =
    "https://knotel.io/images/H2fdbb7f8f2c8ecf49ac437a40b25950ff8c930e9S300x225*W0seO/256cd9a0e3824a9b81e9f41e616019e8";
...
test("getSrcset method returns a string", () => {
  expect(typeof client.getSrcset("abc123", { resize: "200x300" })).toBe(
    "string"
  );
});

test("isImage method returns a promise", () => {
  expect(typeof client.isImage("abc123").then).toBe("function");
});
